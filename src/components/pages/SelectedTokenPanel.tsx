  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <div style={{
        ...
        {tokenState && <span><strong style={{ color: '#e5e5e5' }}>State:</strong> {tokenState.state}</span>}
      </div>
      ...
      {token.socials && (
        <div style={{ display: 'flex', gap: '12px', fontSize: '13px' }}>
          {token.socials.website && (
            <a href={token.socials.website} target="_blank" rel="noopener noreferrer" style={{ color: '#00C805' }}>Website</a>
          )}
          {token.socials.twitter && (
            <a href={token.socials.twitter} target="_blank" rel="noopener noreferrer" style={{ color: '#00C805' }}>Twitter</a>
          )}
          {token.socials.telegram && (
            <a href={token.socials.telegram} target="_blank" rel="noopener noreferrer" style={{ color: '#00C805' }}>Telegram</a>
          )}
        </div>
      )}
    </div>
